...
import com.niit.Time.model.CardDetail;
...
import com.niit.Time.model.ShippingAddress;
...
public class AppplicationContextConfig {
	...
	public DataSource getDataSource() {
	    ...
	    dataSource.setUrl("jdbc:h2:tcp://localhost/~/arun");
